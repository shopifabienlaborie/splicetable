        ...
        window.updateSidebarRoot = function(app, ...keys) {
            if (!app || !keys.length) return;
            window.updateSidebarComponents(app, new Set(keys));
        };

        window.updateSidebarComponents = function(app, dirtyRoots) {
            if (!app) return;
            
            const renderAll = !dirtyRoots;
            const should = (key) => renderAll || dirtyRoots.has(key);
            ...
            // ─── Visibility toggles (only on full refresh) ────────
            if (renderAll) {
            ...
            if (should('backgroundControl') && window.sidebarRoots.backgroundControl) {
                window.sidebarRoots.backgroundControl.render(
                    <Control label="Background">
                        <div style={{display: 'flex', flexDirection: 'column', gap: 'var(--spacing-200)', width: '100%'}}>
                                ...
                                <div id="canvasRatio-inline">
                                    <Select
                                        ...
                                        onChange={(value) => {
                                            ...
                                            window.updateSidebarRoot(app, 'backgroundControl');
                                        }}
                                        options={[
                            ...
                            {/* Background "color" panel — always rendered, animated via CSS */}
                            <div className={`sidebar-reveal ${bgIsColor ? 'active' : ''}`} aria-hidden={!bgIsColor}>
                            ...
                            {/* Background "image" panel — always rendered, animated via CSS */}
                            <div className={`sidebar-reveal ${bgIsImage ? 'active' : ''}`} aria-hidden={!bgIsImage}>
                                <div className="sidebar-reveal-inner">
                                    <ImageReplacer
            ...
            if (should('materialControl') && window.sidebarRoots.materialControl) {
            ...
            if (should('splicerControl') && window.sidebarRoots.splicerControl) {
            ...
            // Canvas Scale Knob
            if (should('canvasScale') && window.sidebarRoots.canvasScale) {
                window.sidebarRoots.canvasScale.render(
                    <Knob
                        ...
                        onChange={(value) => {
                            ...
                            app.scheduleSidebarUpdate('canvasScale');
                        }}
                    />
                );
            }
            ...
            if (should('cellSize') && window.sidebarRoots.cellSize) {
                window.sidebarRoots.cellSize.render(
                    <Knob
                        ...
                        onChange={(value) => {
                            ...
                            app.updateLayoutStyles();
                            app.scheduleSidebarUpdate('cellSize');
                        }}
                    />
                );
            }
            ...
            if (should('cellSpread') && window.sidebarRoots.cellSpread) {
                window.sidebarRoots.cellSpread.render(
                    <Knob
                        ...
                        onChange={(value) => {
                            ...
                            app.updateLayoutStyles();
                            app.scheduleSidebarUpdate('cellSpread');
                        }}
                    />
                );
            }
            ...
            // Cell Tumble Knob
            if (should('cellTumble') && window.sidebarRoots.cellTumble) {
                window.sidebarRoots.cellTumble.render(
                    <Knob
                        ...
                        onChange={(value) => {
                            ...
                            app.updateLayoutStyles();
                            app.scheduleSidebarUpdate('cellTumble');
                        }}
                    />
                );
            }
            ...
            if (should('cellControl') && window.sidebarRoots.cellControl) {
                    ...
                    <Control label="Cell">
                        <SegmentedControl
                            ...
                            onChange={(value) => {
                                ...
                                window.updateSidebarRoot(app, 'cellControl');
                            }}
                        />
                    </Control>
                );
            ...
            if (should('cellCount') && window.sidebarRoots.cellCount) {
                window.sidebarRoots.cellCount.render(
                    <Knob
                        ...
                        loading={!!app._countKnobLoading}
                        onChange={(value) => {
                            app.cellCount = value;
                            app.handleCellCountChange({ target: { value } });
                            app.scheduleSidebarUpdate('cellCount');
                        }}
                    />
                );
            }
            ...
            // Cell Radius Knob
            if (should('cellRadius') && window.sidebarRoots.cellRadius) {
                window.sidebarRoots.cellRadius.render(
                    <Knob
                        ...
                        onChange={(value) => {
                            ...
                            app.updateLayoutStyles();
                            app.scheduleSidebarUpdate('cellRadius');
                        }}
                    />
                );
            }
            ...
            if (should('chaos') && window.sidebarRoots.chaos) {
                window.sidebarRoots.chaos.render(
                    <Knob
                        ...
                        onChange={(value) => {
                            ...
                            app.scheduleRender();
                            app.scheduleSidebarUpdate('chaos');
                        }}
                    />
                );
            }
            ...
            if (should('cellWidth') && window.sidebarRoots.cellWidth) {
                window.sidebarRoots.cellWidth.render(
                    <Knob
                        ...
                        onChange={(value) => {
                            ...
                            app.scheduleSidebarUpdate('cellWidth');
                        }}
                    />
                );
            }
            ...
            if (should('cellHeight') && window.sidebarRoots.cellHeight) {
                window.sidebarRoots.cellHeight.render(
                    <Knob
                        ...
                        onChange={(value) => {
                            ...
                            app.scheduleSidebarUpdate('cellHeight');
                        }}
                    />
                );
            }
            ...
            if (should('lockAspectBtn') && window.sidebarRoots.lockAspectBtn) {
                    ...
                    <React.Fragment>
                        <Button
                            ...
                            onClick={() => {
                                ...
                                window.updateSidebarRoot(app, 'lockAspectBtn');
                            }}
                        />
            ...
            // Export Button
            if (should('exportBtn') && window.sidebarRoots.exportBtn) {
            ...
            // ─── Cell Detail Panel (Panel 2) ──────────────────────
            if (should('cellDetail') && app.selectedCellIndex !== null) {
                const cellIdx = app.selectedCellIndex;
                const cellLabel = `Cell ${cellIdx + 1}`;
                
                // Section title with back navigation
                if (window.sidebarRoots.cellDetailTitle) {
                    window.sidebarRoots.cellDetailTitle.render(
                        <SectionTitle
                            label={cellLabel}
                            level={2}
                            onClick={() => app.deselectCell()}
                        />
                    );
                }
                
                // Lock aspect ratio button (shared by both modes)
                if (window.sidebarRoots.cellDetailLock) {
                    window.sidebarRoots.cellDetailLock.render(
                        <React.Fragment>
                            <Button
                                variant="outline"
                                iconBefore={app.cellDetailAspectLocked ? <LockLockedIcon /> : <LockUnlockedIcon />}
                                label=""
                                className="lock-aspect-button"
                                onClick={() => {
                                    app.cellDetailAspectLocked = !app.cellDetailAspectLocked;
                                    if (app.cellDetailAspectLocked) {
                                        if (isGrid) {
                                            const _col = cellIdx % app.gridSize;
                                            const _row = Math.floor(cellIdx / app.gridSize);
                                            const _tw = app.columnWidths.reduce((a, b) => a + b, 0);
                                            const _th = app.rowHeights.reduce((a, b) => a + b, 0);
                                            const _wp = (app.columnWidths[_col] / _tw) * 100;
                                            const _hp = (app.rowHeights[_row] / _th) * 100;
                                            app.cellDetailLastAspectRatio = _wp / _hp;
                                        } else {
                                            const _cd = app.freestyleCells[cellIdx];
                                            if (_cd) app.cellDetailLastAspectRatio = _cd.width / _cd.height;
                                        }
                                    }
                                    window.updateSidebarRoot(app, 'cellDetail');
                                }}
                            />
                            <span className={`lock-active-dot ${app.cellDetailAspectLocked ? 'engaged' : ''}`} />
                        </React.Fragment>
                    );
                }
                
                if (isGrid) {
                    // ── Stretch mode: Width / Height bound to column/row weights ──
                    const col = cellIdx % app.gridSize;
                    const row = Math.floor(cellIdx / app.gridSize);
                    
                    const totalColWeight = app.columnWidths.reduce((a, b) => a + b, 0);
                    const totalRowWeight = app.rowHeights.reduce((a, b) => a + b, 0);
                    
                    const colPercent = Math.round((app.columnWidths[col] / totalColWeight) * 100);
                    const rowPercent = Math.round((app.rowHeights[row] / totalRowWeight) * 100);
                    
                    // Show / Hide toggle (Stretch mode only)
                    const isCellHidden = app.hiddenCells.has(cellIdx);
                    if (window.sidebarRoots.cellDetailVisibility) {
                        window.sidebarRoots.cellDetailVisibility.render(
                            <SegmentedControl
                                fullWidth={true}
                                value={isCellHidden ? 'hide' : 'show'}
                                onChange={(value) => {
                                    if (value === 'hide') {
                                        app.hiddenCells.add(cellIdx);
                                    } else {
                                        app.hiddenCells.delete(cellIdx);
                                    }
                                    app.scheduleRender();
                                    app.scheduleSidebarUpdate('cellDetail');
                                }}
                                items={[
                    ...
                    if (window.sidebarRoots.cellDetailWidth) {
                        window.sidebarRoots.cellDetailWidth.render(
                            <Knob
                                label="Width"
                                min={5}
                                max={95}
                                ...
                                showPercentage={true}
                                onChange={(value) => {
                                    const otherColWeights = app.columnWidths.filter((_, i) => i !== col);
                                    const sumOtherCol = otherColWeights.reduce((a, b) => a + b, 0);
                                    const pct = Math.max(5, Math.min(95, value)) / 100;
                                    app.columnWidths[col] = (pct * sumOtherCol) / (1 - pct);
                                    
                                    if (app.cellDetailAspectLocked && app.cellDetailLastAspectRatio) {
                                        const newRowPct = Math.max(5, Math.min(95, value / app.cellDetailLastAspectRatio));
                                        const otherRowWeights = app.rowHeights.filter((_, i) => i !== row);
                                        const sumOtherRow = otherRowWeights.reduce((a, b) => a + b, 0);
                                        const rPct = newRowPct / 100;
                                        app.rowHeights[row] = (rPct * sumOtherRow) / (1 - rPct);
                                    }
                    ...
                    if (window.sidebarRoots.cellDetailHeight) {
                        window.sidebarRoots.cellDetailHeight.render(
                            <Knob
                                label="Height"
                                min={5}
                                max={95}
                                ...
                                onChange={(value) => {
                                    ...
                                    const sumOtherRow = otherRowWeights.reduce((a, b) => a + b, 0);
                                    const pct = Math.max(5, Math.min(95, value)) / 100;
                                    app.rowHeights[row] = (pct * sumOtherRow) / (1 - pct);
                                    
                                    if (app.cellDetailAspectLocked && app.cellDetailLastAspectRatio) {
                                        const newColPct = Math.max(5, Math.min(95, value * app.cellDetailLastAspectRatio));
                                        const otherColWeights = app.columnWidths.filter((_, i) => i !== col);
                                        const sumOtherCol = otherColWeights.reduce((a, b) => a + b, 0);
                                        const cPct = newColPct / 100;
                                        app.columnWidths[col] = (cPct * sumOtherCol) / (1 - cPct);
                                    }
                    ...
                    // Reset override button (Stretch mode)
                    if (window.sidebarRoots.cellDetailReset) {
                        window.sidebarRoots.cellDetailReset.render(
                            <Button
                                variant="outline"
                                ...
                                fullWidth={true}
                                onClick={() => {
                                    app.columnWidths[col] = 1;
                                    app.rowHeights[row] = 1;
                                    app.hiddenCells.delete(cellIdx);
                                    app.scheduleRender();
                                    app.deselectCell();
                                }}
                    ...
                    // ── Scatter mode: no visibility toggle ──
                    if (window.sidebarRoots.cellDetailVisibility) {
                        window.sidebarRoots.cellDetailVisibility.render(null);
                    }
                    
                    // ── Scatter mode: Width / Height bound to individual cell dimensions ──
                    const cellData = app.freestyleCells[cellIdx];
                    const cellW = cellData ? Math.round(cellData.width) : 100;
                    const cellH = cellData ? Math.round(cellData.height) : 100;
                    ...
                    if (window.sidebarRoots.cellDetailWidth) {
                        window.sidebarRoots.cellDetailWidth.render(
                            <Knob
                                ...
                                onChange={(value) => {
                                    if (cellData) {
                                        app.selectedCellIndex = cellIdx;
                                        let newH = cellData.height;
                                        if (app.cellDetailAspectLocked && app.cellDetailLastAspectRatio) {
                                            newH = Math.max(10, Math.min(500, Math.round(value / app.cellDetailLastAspectRatio)));
                                        }
                                        app.applyCellDimensions(value, newH);
                                        app.scheduleSidebarUpdate('cellDetail');
                                    }
                                }}
                            />
                        ...
                        window.sidebarRoots.cellDetailHeight.render(
                            <Knob
                                ...
                                onChange={(value) => {
                                    if (cellData) {
                                        app.selectedCellIndex = cellIdx;
                                        let newW = cellData.width;
                                        if (app.cellDetailAspectLocked && app.cellDetailLastAspectRatio) {
                                            newW = Math.max(10, Math.min(500, Math.round(value * app.cellDetailLastAspectRatio)));
                                        }
                                        app.applyCellDimensions(newW, value);
                                        app.scheduleSidebarUpdate('cellDetail');
                                    }
                                }}
                            />
                    ...
                    // Reset override button (Scatter only)
                    if (window.sidebarRoots.cellDetailReset) {
                        window.sidebarRoots.cellDetailReset.render(
                            <Button
                                variant="outline"
                                ...
                                fullWidth={true}
                                onClick={() => {
                                    // Find default dimensions from a non-modified sibling
                                    const sibling = app.freestyleCells.find((c, i) => i !== cellIdx && !c.individuallyModified);
                                    if (sibling && cellData) {
                                        app.selectedCellIndex = cellIdx;
                                        app.applyCellDimensions(sibling.width, sibling.height);
                                        cellData.individuallyModified = false;
                                    }
                                    // Navigate back
                                    app.deselectCell();
                                }}
        ...
        waitForComponents(() => {
            ...
            window.updateNavbar = function(imageSrc, fileName) {
                ...
                window.navbarRoot.render(
                    <Navbar
                        ...
                        onReset={() => {
                            if (window.appInstance && window.appInstance.image) {
                                window.appInstance.resetToDefaults();
                                window.appInstance.initializeForMode();
                                window.appInstance.renderContent();
                                if (window.updateSidebarComponents) window.updateSidebarComponents(window.appInstance);
                            }
                        }}
                        hideViewToggle={true}
            ...
            // Cell detail panel (Panel 2)
            window.sidebarRoots.cellDetailTitle = ReactDOM.createRoot(document.getElementById('cellDetail-sectionTitle-root'));
            window.sidebarRoots.cellDetailVisibility = ReactDOM.createRoot(document.getElementById('cellDetail-visibility-root'));
            window.sidebarRoots.cellDetailWidth = ReactDOM.createRoot(document.getElementById('cellDetail-width-root'));
            window.sidebarRoots.cellDetailLock = ReactDOM.createRoot(document.getElementById('cellDetail-lock-root'));
            window.sidebarRoots.cellDetailHeight = ReactDOM.createRoot(document.getElementById('cellDetail-height-root'));
            window.sidebarRoots.cellDetailReset = ReactDOM.createRoot(document.getElementById('cellDetail-resetOverride-root'));
